...
void main() {
	...
	`}function Tm(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){let c=a.mapping,l=c===Go||c===Wo,h=c===vi||c===yi;if(l||h){let u=t.get(a),f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new Ra(i)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{let p=a.image;return l&&p&&p.height>0||h&&p&&s(p)?(e===null&&(e=new Ra(i)),u=l?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let c=0,l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){let c=a.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function Em(i){let t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){let s=e(n);return s===null&&Yi("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Am(i,t,e,n){let s={},r=new WeakMap;function o(u){let f=u.target;f.index!==null&&t.remove(f.index);for(let g in f.attributes)t.remove(f.attributes[g]);f.removeEventListener("dispose",o),delete s[f.id];let p=r.get(f);p&&(t.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(u,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,e.memory.geometries++),f}function c(u){let f=u.attributes;for(let p in f)t.update(f[p],i.ARRAY_BUFFER)}function l(u){let f=[],p=u.index,g=u.attributes.position,x=0;if(p!==null){let E=p.array;x=p.version;for(let T=0,S=E.length;T<S;T+=3){let C=E[T+0],A=E[T+1],I=E[T+2];f.push(C,A,A,I,I,C)}}else if(g!==void 0){let E=g.array;x=g.version;for(let T=0,S=E.length/3-1;T<S;T+=3){let C=T+0,A=T+1,I=T+2;f.push(C,A,A,I,I,C)}}else return;let m=new(tl(f)?Hs:Vs)(f,1);m.version=x;let d=r.get(u);d&&t.remove(d),r.set(u,m)}function h(u){let f=r.get(u);if(f){let p=u.index;p!==null&&f.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function Cm(i,t,e){let n;function s(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function c(f,p){i.drawElements(n,p,r,f*o),e.update(p,n,1)}function l(f,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,f*o,g),e.update(p,n,g))}function h(f,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];e.update(m,n,1)}function u(f,p,g,x){if(g===0)return;let m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/o,p[d],x[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,x,0,g);let d=0;for(let E=0;E<g;E++)d+=p[E]*x[E];e.update(d,n,1)}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Rm(i){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function Pm(i,t,e){let n=new WeakMap,s=new Qt;function r(o,a,c){let l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0,f=n.get(a);if(f===void 0||f.count!==u){let M=function(){I.dispose(),n.delete(a),a.removeEventListener("dispose",M)};f!==void 0&&f.texture.dispose();let p=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,x=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],d=a.morphAttributes.normal||[],E=a.morphAttributes.color||[],T=0;p===!0&&(T=1),g===!0&&(T=2),x===!0&&(T=3);let S=a.attributes.position.count*T,C=1;S>t.maxTextureSize&&(C=Math.ceil(S/t.maxTextureSize),S=t.maxTextureSize);let A=new Float32Array(S*C*4*u),I=new ks(A,S,C,u);I.type=vn,I.needsUpdate=!0;let F=T*4;for(let y=0;y<u;y++){let D=m[y],k=d[y],H=E[y],Y=S*C*4*y;for(let J=0;J<D.count;J++){let W=J*F;p===!0&&(s.fromBufferAttribute(D,J),A[Y+W+0]=s.x,A[Y+W+1]=s.y,A[Y+W+2]=s.z,A[Y+W+3]=0),g===!0&&(s.fromBufferAttribute(k,J),A[Y+W+4]=s.x,A[Y+W+5]=s.y,A[Y+W+6]=s.z,A[Y+W+7]=0),x===!0&&(s.fromBufferAttribute(H,J),A[Y+W+8]=s.x,A[Y+W+9]=s.y,A[Y+W+10]=s.z,A[Y+W+11]=H.itemSize===4?s.w:1)}}f={count:u,texture:I,size:new St(S,C)},n.set(a,f),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let p=0;for(let x=0;x<l.length;x++)p+=l[x];let g=a.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Im(i,t,e,n){let s=new WeakMap;function r(c){let l=n.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return u}function o(){s=new WeakMap}function a(c){let l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}var Hu=new Be,wu=new Ys(1,1),Gu=new ks,Wu=new fo,Xu=new Ws,Tu=[],Eu=[],Au=new Float32Array(16),Cu=new Float32Array(9),Ru=new Float32Array(4);function fs(i,t,e){let n=i[0];if(n<=0||n>0)return i;let s=t*e,r=Tu[s];if(r===void 0&&(r=new Float32Array(s),Tu[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function ve(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function ye(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Ia(i,t){let e=Eu[t];e===void 0&&(e=new Int32Array(t),Eu[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Dm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Lm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ve(e,t))return;i.uniform2fv(this.addr,t),ye(e,t)}}function Um(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ve(e,t))return;i.uniform3fv(this.addr,t),ye(e,t)}}function Nm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ve(e,t))return;i.uniform4fv(this.addr,t),ye(e,t)}}function Fm(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(ve(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),ye(e,t)}else{if(ve(e,n))return;Ru.set(n),i.uniformMatrix2fv(this.addr,!1,Ru),ye(e,n)}}function Om(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(ve(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),ye(e,t)}else{if(ve(e,n))return;Cu.set(n),i.uniformMatrix3fv(this.addr,!1,Cu),ye(e,n)}}function Bm(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(ve(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),ye(e,t)}else{if(ve(e,n))return;Au.set(n),i.uniformMatrix4fv(this.addr,!1,Au),ye(e,n)}}function zm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function km(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ve(e,t))return;i.uniform2iv(this.addr,t),ye(e,t)}}function Vm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ve(e,t))return;i.uniform3iv(this.addr,t),ye(e,t)}}function Hm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ve(e,t))return;i.uniform4iv(this.addr,t),ye(e,t)}}function Gm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Wm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ve(e,t))return;i.uniform2uiv(this.addr,t),ye(e,t)}}function Xm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ve(e,t))return;i.uniform3uiv(this.addr,t),ye(e,t)}}function qm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ve(e,t))return;i.uniform4uiv(this.addr,t),ye(e,t)}}function Ym(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(wu.compareFunction=Kc,r=wu):r=Hu,e.setTexture2D(t||r,s)}function Zm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Wu,s)}function Jm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Xu,s)}function $m(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Gu,s)}function Km(i){switch(i){case 5126:return Dm;case 35664:return Lm;case 35665:return Um;case 35666:return Nm;case 35674:return Fm;case 35675:return Om;case 35676:return Bm;case 5124:case 35670:return zm;case 35667:case 35671:return km;case 35668:case 35672:return Vm;case 35669:case 35673:return Hm;case 5125:return Gm;case 36294:return Wm;case 36295:return Xm;case 36296:return qm;case 35678:case 36198:case 36298:case 36306:case 35682:return Ym;case 35679:case 36299:case 36307:return Zm;case 35680:case 36300:case 36308:case 36293:return Jm;case 36289:case 36303:case 36311:case 36292:return $m}}function jm(i,t){i.uniform1fv(this.addr,t)}function Qm(i,t){let e=fs(t,this.size,2);i.uniform2fv(this.addr,e)}function t1(i,t){let e=fs(t,this.size,3);i.uniform3fv(this.addr,e)}function e1(i,t){let e=fs(t,this.size,4);i.uniform4fv(this.addr,e)}function n1(i,t){let e=fs(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function i1(i,t){let e=fs(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function s1(i,t){let e=fs(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function r1(i,t){i.uniform1iv(this.addr,t)}function o1(i,t){i.uniform2iv(this.addr,t)}function a1(i,t){i.uniform3iv(this.addr,t)}function c1(i,t){i.uniform4iv(this.addr,t)}function l1(i,t){i.uniform1uiv(this.addr,t)}function h1(i,t){i.uniform2uiv(this.addr,t)}function u1(i,t){i.uniform3uiv(this.addr,t)}function d1(i,t){i.uniform4uiv(this.addr,t)}function f1(i,t,e){let n=this.cache,s=t.length,r=Ia(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),ye(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||Hu,r[o])}function p1(i,t,e){let n=this.cache,s=t.length,r=Ia(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),ye(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Wu,r[o])}function m1(i,t,e){let n=this.cache,s=t.length,r=Ia(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),ye(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Xu,r[o])}function g1(i,t,e){let n=this.cache,s=t.length,r=Ia(e,s);ve(n,r)||(i.uniform1iv(this.addr,r),ye(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Gu,r[o])}function _1(i){switch(i){case 5126:return jm;case 35664:return Qm;case 35665:return t1;case 35666:return e1;case 35674:return n1;case 35675:return i1;case 35676:return s1;case 5124:case 35670:return r1;case 35667:case 35671:return o1;case 35668:case 35672:return a1;case 35669:case 35673:return c1;case 5125:return l1;case 36294:return h1;case 36295:return u1;case 36296:return d1;case 35678:case 36198:case 36298:case 36306:case 35682:return f1;case 35679:case 36299:case 36307:return p1;case 35680:case 36300:case 36308:case 36293:return m1;case 36289:case 36303:case 36311:case 36292:return g1}}var ul=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Km(e.type)}},dl=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=_1(e.type)}},fl=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){let s=this.seq;for(let r=0,o=s.length;r!==o;++r){let a=s[r];a.setValue(t,e[a.id],n)}}},hl=/(\w+)(\])?(\[|\.)?/g;function Pu(i,t){i.seq.push(t),i.map[t.id]=t}function x1(i,t,e){let n=i.name,s=n.length;for(hl.lastIndex=0;;){let r=hl.exec(n),o=hl.lastIndex,a=r[1],c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Pu(e,l===void 0?new ul(a,i,t):new dl(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new fl(a),Pu(e,u)),e=u}}}var ds=class{constructor(t,e){this.seq=[],this.map={};let n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);x1(r,o,this)}}setValue(t,e,n,s){let r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){let s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){let a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){let n=[];for(let s=0,r=t.length;s!==r;++s){let o=t[s];o.id in e&&n.push(o)}return n}};function Iu(i,t,e){let n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}var v1=37297,y1=0;function M1(i,t){let e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){let a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}var Du=new zt;function S1(i){qt._getMatrix(Du,qt.workingColorSpace,i);let t=`mat3( ${Du.elements.map(e=>e.toFixed(4))} )`;switch(qt.getTransfer(i)){case Bs:return[t,"LinearTransferOETF"];case $t:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Lu(i,t,e){let n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return e.toUpperCase()+`

`+r+`

`+M1(i.getShaderSource(t),a)}else return r}function b1(i,t){let e=S1(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function w1(i,t){let e;switch(t){case Oo:e="Linear";break;case Bo:e="Reinhard";break;case zo:e="Cineon";break;case rs:e="ACESFilmic";break;case Vo:e="AgX";break;case Ho:e="Neutral";break;case ko:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Ca=new R;function T1(){qt.getLuminanceCoefficients(Ca);let i=Ca.x.toFixed(4),t=Ca.y.toFixed(4),e=Ca.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function E1(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(pr).join(`
`)}function A1(i){let t=[];for(let e in i){let n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function C1(i,t){let e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(t,s),o=r.name,a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function pr(i){return i!==""}function Uu(i,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Nu(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var R1=/^[ \t]*#include +<([\w\d./]+)>/gm;function pl(i){return i.replace(R1,I1)}var P1=new Map;function I1(i,t){let e=Ht[t];if(e===void 0){let n=P1.get(t);if(n!==void 0)e=Ht[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return pl(e)}var D1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fu(i){return i.replace(D1,L1)}function L1(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ou(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function U1(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Oc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Fh?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===xn&&(t="SHADOWMAP_TYPE_VSM"),t}function N1(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case vi:case yi:t="ENVMAP_TYPE_CUBE";break;case ar:t="ENVMAP_TYPE_CUBE_UV";break}return t}function F1(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case yi:t="ENVMAP_MODE_REFRACTION";break}return t}function O1(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case kc:t="ENVMAP_BLENDING_MULTIPLY";break;case eu:t="ENVMAP_BLENDING_MIX";break;case nu:t="ENVMAP_BLENDING_ADD";break}return t}function B1(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function z1(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,c=U1(e),l=N1(e),h=F1(e),u=O1(e),f=B1(e),p=E1(e),g=A1(r),x=s.createProgram(),m,d,E=e.glslVersion?"#version "+e.glslVersion+`
...
totalEmissiveRadiance *= 1.0-smoothstep(-0.2,0.15,dot(normalize(worldN),sunDirection));`)};let l=new xe(Wl,new pe({transparent:!0,depthWrite:!1,side:Ee,blending:jn,uniforms:{tint:{value:new Ot("#458edb")}},vertexShader:"varying vec3 n; varying vec3 v; void main(){vec4 p=modelViewMatrix*vec4(position,1.0); n=normalize(normalMatrix*normal);v=normalize(-p.xyz);gl_Position=projectionMatrix*p;}",fragmentShader:"varying vec3 n;varying vec3 v;uniform vec3 tint;void main(){float a=pow(1.0-abs(dot(normalize(n),normalize(v))),3.0);gl_FragColor=vec4(tint,a*.55);}"}));l.scale.setScalar(1.027),r.add(l)}if(i.id==="Saturn"){let a=new $s(1.24,2.32,160,8),c=a.attributes.position,l=a.attributes.uv;for(let u=0;u<c.count;u++){let f=Math.hypot(c.getX(u),c.getY(u));l.setXY(u,(f-1.24)/(2.32-1.24),.5)}let h=new xe(a,new _i({map:Ka("2k_saturn_ring_alpha.png"),transparent:!0,side:tn,roughness:1,depthWrite:!1,alphaTest:.08}));h.rotation.x=-Math.PI/2,r.add(h)}if(i.id==="Earth")for(let a of r.children)a.material.isShaderMaterial&&(a.material.depthTest=!1)}function Rr(i=!1){let t=new Date(Z.ms);for(let e of Fn){let n;if(e.parent){let s=ri.get(e.parent),r=e.ephemeris?x0(e.id,t):M0(e,t);if(e.au=s.au.map((o,a)=>o+r[a]),Z.physical)n=e.au.map(o=>o*100);else{let o=s.mesh.scale.x*(3+Math.log1p(e.distance/s.radius)*1.6),a=Math.hypot(...r);n=r.map((c,l)=>s.root.position.getComponent(l)+c/a*o)}}else e.au=Hl(e.id,t),n=$a(e.au,Z.physical);e.root.position.fromArray(n),e.mesh.scale.setScalar(si(e)),e.mesh.rotation.y=Z.ms/ws*24/(e.rotation||e.period*24||24)%1*Math.PI*2,e.shader&&e.shader.uniforms.sunDirection.value.copy(e.root.position).multiplyScalar(-1).normalize()}Z.lastEphem=performance.now()}function ja(i){for(let t of[...i.children])t.geometry?.dispose(),t.material?.dispose(),i.remove(t)}function $l(){ja(Tr);let i=new Date(Z.ms);for(let t of _r.filter(e=>e.id!=="Sun")){let e=[],n=y0(t.id);for(let s=0;s<=160;s++)e.push(new R(...$a(Hl(t.id,new Date(+i+s/160*n*ws)),Z.physical)));Tr.add(new qs(new we().setFromPoints(e),new Qi({color:6454161,transparent:!0,opacity:.22})))}}function Xl(i){let t=Math.sin(i*127.1+311.7)*43758.5453;return t-Math.floor(t)}function R0(){ja(Er);for(let[i,t,e,n,s]of[[2.1,3.3,9e3,12166796,.45],[30,50,16e3,8894414,.44],[.4,5,3e3,13939083,.055]]){let r=[];for(let a=0;a<e;a++){let c=i+(t-i)*Xl(a+i),l=Xl(a+3e4)*Math.PI*2,h=(Xl(a+5e4)-.5)*c*.09;r.push(...$a([Math.cos(l)*c,h,Math.sin(l)*c],Z.physical))}let o=new we;o.setAttribute("position",new le(r,3)),Er.add(new es(o,C0({color:n,size:Z.physical?.6:.22,opacity:s,sizeAttenuation:!0,blending:jn})))}}var ql=[],Yl=null,f_=null,p_=null,Zl=[];function m_(i,t){let e=t-2e3;return bs({x:i.x+i.vx*e,y:i.y+i.vy*e,z:i.z+i.vz*e,t:0})}function Kl(){ja(Ar),ja(Cr);let i=[],t=[],e=[],n=[];Zl=[];let s=2e3+(Z.ms-Date.UTC(2e3,0,1))/ws/365.25;for(let r of ql){let o=m_(r,s),a=new R(...o).normalize();t.push(...a.multiplyScalar(15e3).toArray());let c=Math.max(.12,Math.min(2,Math.pow(10,-.16*r.mag)*2.5)),l=new Ot(r.ci<.3?"#adceff":r.ci>1.1?"#ffd0a0":"#e8edff");l.multiplyScalar(c),e.push(l.r,l.g,l.b),r.dist<1e5&&(i.push(...o),n.push(l.r,l.g,l.b),r.name&&!r.name.startsWith("HIP")&&r.mag<3.2&&Zl.push({...r,type:"Ster",point:new R(...o)}))}for(let[r,o,a]of[[Ar,t,!0],[Cr,i,!1]]){let c=new we;c.setAttribute("position",new le(o,3)),c.setAttribute("color",new le(a?e:n,3));let l=C0({size:a?1.6:2.5,sizeAttenuation:!1,vertexColors:!0,opacity:.92}),h=new es(c,l);r.add(h),a?p_=h:f_=h}Z.starEpoch=s}var Pr=document.createElement("div");Pr.className="world-dock";Pr.setAttribute("aria-label","Direct naar een planeet");document.body.append(Pr);var jl=document.createElement("link");jl.rel="stylesheet";jl.href="dock.css";document.head.append(jl);for(let i of _r.filter(t=>t.texture&&t.id!=="Sun")){let t=document.createElement("button"),e=document.createElement("span"),n=document.createElement("small");e.className="world-thumb",e.style.backgroundImage="url(assets/planets/"+(i.texture==="earth"?"2k_earth_daymap.jpg":i.texture==="mars"?"2k_mars.jpg":A0[i.texture])+")",n.textContent=i.name,t.append(e,n),t.onclick=()=>pn(ri.get(i.id)),Pr.append(t)}function Ql(){tt("#panel").hidden=!1,tt("#showPanel").hidden=!0}function pn(i,t=!1){Z.flight&&oi(!1),Z.sector&&Dr(!1),Z.selected=i,Z.track=i,Z.tour=!1,tt("#tour").classList.remove("active"),tt("#title").textContent=i.name,tt("#kind").textContent=(i.parent?"MAAN VAN "+ri.get(i.parent).name:i.type||"Maan").toUpperCase(),tt("#subtitle").textContent=i.parent?"Een wereld rond een wereld.":"Sleep om rond te kijken. Scroll of knijp om te naderen.",tt("#objectName").textContent=i.name,tt("#fact").textContent=i.fact||"Een natuurlijke satelliet. De neutrale bol toont geen verzonnen oppervlaktekartering.";let e=Math.hypot(...i.au);tt("#metrics").innerHTML="<div><small>Straal</small><strong>"+ii.format(i.radius)+" km</strong></div><div><small>Afstand tot zon</small><strong>"+ii.format(e)+" AE</strong></div><div><small>Positie</small><strong>"+(i.parent&&!i.ephemeris?"Illustratief model":"Berekende ephemeride")+"</strong></div><div><small>Oppervlak</small><strong>"+(i.texture?"Beeldkaart":"Neutraal model")+"</strong></div>",tt("#moonList").replaceChildren();for(let a of xr.filter(c=>c.parent===(i.parent||i.id))){let c=document.createElement("button");c.textContent=a.name,c.onclick=()=>pn(ri.get(a.id)),tt("#moonList").append(c)}tt("#modelNote").textContent=(Z.physical?"Echte afstanden en stralen. ":"Afstanden gecomprimeerd; objecten vergroot. ")+(i.parent&&!i.ephemeris?"Deze maanpositie is illustratief.":"Standen volgen de simulatietijd.")+" Beeldkaarten: Solar System Scope / INOVE, CC BY 4.0.",Ql(),tt("#moons").disabled=!xr.some(a=>a.parent===i.id);let n=si(i),s=t?n*30:n*(i.id==="Saturn"?8:5.8),r=i.root.position.clone().negate().normalize();r.lengthSq()===0&&r.set(1,0,1);let o=r.multiplyScalar(s*.7).add(new R(s*.5,s*.25,s*.6)).normalize().multiplyScalar(s);Ir(i.root.position.clone().add(o),i.root.position.clone())}function Ir(i,t){Z.transition={start:performance.now(),from:ie.position.clone(),to:i,fromTarget:Fe.target.clone(),target:t}}function P0(){Z.flight&&oi(!1),Z.sector&&Dr(!1),Z.track=null,Z.selected=null;let i=Z.physical?8500:240;Ir(new R(i*.3,i*.68,i*.78),new R),tt("#title").textContent="Zonnestelsel",tt("#kind").textContent="ONZE KOSMISCHE BUURT",tt("#subtitle").textContent="Echte baanrichtingen. Werelden van rots, gas en ijs.",tt("#panel").hidden=!0,tt("#showPanel").hidden=!0}function Dr(i){Z.sector=i,Qa.visible=!i,Tr.visible=!i&&tt("#orbits").checked,Er.visible=!i&&tt("#belts").checked,Cr.visible=i,Ar.visible=!i,tt("#stars").classList.toggle("active",i);for(let t of Es)t.el.hidden=i;i&&(Z.track=null,Z.selected=null,Ir(new R(12,20,65),new R),tt("#title").textContent="Het sterrenveld",tt("#kind").textContent="HYG \xB7 J2000 + RUIMTEBEWEGING",tt("#subtitle").textContent="25.791 catalogussterren. Afstanden in parsecs.",tt("#panel").hidden=!0,tt("#showPanel").hidden=!0)}function oi(i){Z.flight=i,Fe.enabled=!i,Z.transition=null,tt("#hud").hidden=!i,tt("#flight").classList.toggle("active",i),tt("#flight").textContent=i?"\u25C7 Verlaat ruimteschip":"\u25C7 Ruimteschip",Z.keys.clear(),i?(Z.track=null,tt("#panel").hidden=!0,tt("#showPanel").hidden=!Z.selected):Fe.target.copy(ie.position).add(ie.getWorldDirection(new R).multiplyScalar(Z.selected?si(Z.selected)*5:25))}var Ts=new R;function g_(i){let t=1/0;for(let r of Fn){if(Z.sector)break;let o=ie.position.distanceTo(r.root.position)-si(r);t=Math.min(t,Math.max(o,si(r)*.02))}let e=Z.sector?8:Math.max(Z.physical?2e-5:.08,Math.min(Z.physical?2e3:80,t*.5)),n=Z.keys,s=new R((n.has("d")||n.has("arrowright")?1:0)-(n.has("a")||n.has("arrowleft")?1:0),(n.has("r")?1:0)-(n.has("f")?1:0),(n.has("s")||n.has("arrowdown")?1:0)-(n.has("w")||n.has("arrowup")?1:0));s.lengthSq()&&s.normalize(),s.applyQuaternion(ie.quaternion).multiplyScalar(e*(n.has("shift")?12:1)),Ts.lerp(s,1-Math.exp(-i*5)),ie.position.addScaledVector(Ts,i),n.has("q")&&ie.rotateZ(i*.7),n.has("e")&&ie.rotateZ(-i*.7);for(let r of Fn){if(Z.sector)break;let o=ie.position.clone().sub(r.root.position),a=si(r)*1.04;o.length()<a&&(o.setLength(a),ie.position.copy(r.root.position).add(o),Ts.set(0,0,0))}tt("#velocity").textContent=Z.sector?ii.format(Ts.length())+" pc/s":Z.physical?ii.format(Ts.length()/100*Ss)+" km/s":ii.format(Ts.length())+" sc\xE8ne-eenheden/s"}var S0=new rr,Nn=null,th=!1;ge.domElement.addEventListener("pointerdown",i=>{Nn={x:i.clientX,y:i.clientY},th=!1});ge.domElement.addEventListener("pointermove",i=>{if(!Nn)return;let t=i.clientX-Nn.x,e=i.clientY-Nn.y;Math.abs(t)+Math.abs(e)>3&&(th=!0),Z.flight&&(ie.rotateOnWorldAxis(new R(0,1,0),-t*.003),ie.rotateX(-e*.003)),Nn={x:i.clientX,y:i.clientY}});ge.domElement.addEventListener("pointerup",i=>{if(Nn&&!th&&!Z.flight&&!Z.sector){S0.setFromCamera(new St(i.clientX/innerWidth*2-1,-i.clientY/innerHeight*2+1),ie);let t=S0.intersectObjects(Fn.map(e=>e.mesh),!1)[0];t&&pn(t.object.userData.item)}Nn=null});ge.domElement.addEventListener("pointercancel",()=>Nn=null);addEventListener("keydown",i=>{/INPUT|SELECT|TEXTAREA/.test(i.target.tagName)||(i.key==="Escape"&&Z.flight&&oi(!1),Z.keys.add(i.key.toLowerCase()),Z.flight&&["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(i.key)&&i.preventDefault())});addEventListener("keyup",i=>Z.keys.delete(i.key.toLowerCase()));addEventListener("blur",()=>{Z.keys.clear(),Nn=null});document.querySelectorAll("[data-key]").forEach(i=>{i.onpointerdown=t=>{i.setPointerCapture(t.pointerId),Z.keys.add(i.dataset.key)},i.onpointerup=i.onpointercancel=()=>Z.keys.delete(i.dataset.key)});tt("#flight").onclick=()=>oi(!Z.flight);tt("#overview").onclick=P0;tt("#stars").onclick=()=>{Z.flight&&oi(!1),Dr(!0)};tt("#focus").onclick=()=>Z.selected&&pn(Z.selected);tt("#moons").onclick=()=>Z.selected&&pn(Z.selected,!0);tt("#hidePanel").onclick=()=>{tt("#panel").hidden=!0,tt("#showPanel").hidden=!1};tt("#showPanel").onclick=Ql;tt("#tour").onclick=()=>{Z.flight&&oi(!1),Z.tour=!Z.tour,tt("#tour").classList.toggle("active",Z.tour),Fe.autoRotate=Z.tour,Fe.autoRotateSpeed=.6};tt("#pause").onclick=()=>{Z.paused=!Z.paused,tt("#pause").textContent=Z.paused?"\u25B6":"\u2161"};tt("#speed").onchange=i=>Z.speed=+i.target.value;tt("#now").onclick=()=>{Z.ms=Date.now(),Z.speed=1,Z.paused=!1,tt("#pause").textContent="\u2161",tt("#speed").value="1",Rr()};tt("#date").onchange=i=>{let t=Date.parse(i.target.value+"Z");Number.isFinite(t)&&t>=Date.UTC(1900,0,1)&&t<Date.UTC(2101,0,1)&&(Z.ms=t,Z.speed=1,tt("#speed").value="1",Rr(),$l(),Kl(),Z.selected&&pn(Z.selected))};tt("#scale").onchange=i=>{Z.physical=i.target.value==="physical",Rr(),$l(),R0(),Z.selected?pn(Z.selected):P0()};tt("#orbits").onchange=i=>Tr.visible=i.target.checked&&!Z.sector;tt("#belts").onchange=i=>Er.visible=i.target.checked&&!Z.sector;tt("#quality").onchange=i=>{let t=i.target.value;ge.setPixelRatio(t==="ultra"?Math.min(3,Math.max(1,devicePixelRatio)):t==="low"?1:Math.min(devicePixelRatio,1.75)),E0.enabled=t!=="low",D0()};tt("#info").onclick=()=>tt("#about").showModal();tt("#closeAbout").onclick=()=>tt("#about").close();var I0=document.createElement("p");I0.textContent="Sterren zonder bruikbare catalogusafstand worden alleen als hemelrichting getoond, niet als een verzonnen 3D-locatie. De atlasweergave van andere sterrenstelsels blijft schematisch. Dit is geen volledige reconstructie van alle objecten in het heelal.";tt("#about").append(I0);function wr(i,t,e){let n=document.createElement("button");n.textContent=i;let s=document.createElement("small");s.textContent=t,n.append(s),n.onclick=()=>{tt("#results").hidden=!0,tt("#search").blur(),e()},tt("#results").append(n)}tt("#search").oninput=i=>{let t=i.target.value.toLocaleLowerCase().trim();if(tt("#results").replaceChildren(),tt("#results").hidden=!t,!!t){for(let e of Fn.filter(n=>n.name.toLocaleLowerCase().includes(t)||n.id.toLowerCase().includes(t)).slice(0,8))wr(e.name,e.parent?"Maan":"Zonnestelsel",()=>pn(e));for(let e of $u.filter(n=>n.name.toLowerCase().includes(t)))wr(e.name,e.type,()=>x_(e));for(let e of Zl.filter(n=>n.name.toLowerCase().includes(t)).slice(0,4))wr(e.name,"Ster \xB7 "+ii.format(e.dist)+" pc",()=>__(e));if(Yl)for(let e of Yl.systems.filter(n=>n.name.toLowerCase().includes(t)).slice(0,3))wr(e.name,e.planets.length+" bevestigde exoplaneten",()=>{location.href="atlas.html?system="+encodeURIComponent(e.name)});tt("#results").children.length||wr("Geen bestemming gevonden","Probeer Aarde, Titan, Carina, Sirius of TRAPPIST",()=>{})}};document.addEventListener("click",i=>{i.target.closest(".search")||(tt("#results").hidden=!0)});function __(i){Z.flight&&oi(!1),Dr(!0),Z.track=null,Ir(i.point.clone().add(new R(1,1,3)),i.point),tt("#title").textContent=i.name,tt("#subtitle").textContent=ii.format(i.dist)+" parsec van de zon \xB7 magnitude "+i.mag,tt("#kind").textContent="CATALOGUSSTER"}function x_(i){Z.flight&&oi(!1),Dr(!0),Z.track=null,Z.selected=null;let t=new R(...v0(i.ra,i.dec)).normalize();if(Ir(new R,t.multiplyScalar(1e3)),tt("#title").textContent=i.name,tt("#kind").textContent=i.type,tt("#subtitle").textContent=ii.format(i.distance)+" lichtjaar \xB7 J2000-richting",tt("#objectName").textContent=i.name,tt("#fact").textContent=i.fact,tt("#metrics").replaceChildren(),tt("#moonList").replaceChildren(),tt("#moons").disabled=!0,tt("#modelNote").textContent="Telescoopbeeld met toegewezen kleuren; geen realtime zichtbare-lichtopname. Bron en credits onder Bronnen.",i.image){let e=document.createElement("img");e.src=i.image,e.alt=i.name,e.style.gridColumn="1 / -1",tt("#metrics").append(e)}Ql()}function v_(){if(Z.sector){for(let n of Es)n.el.hidden=!0;return}ie.updateMatrixWorld();let i=ie.position.toArray(),t=innerHeight/(2*Math.tan(fr.degToRad(ie.fov/2))),e=Fn.map(n=>{let s=n.root.position,r=s.clone().applyMatrix4(ie.matrixWorldInverse),o=s.clone().project(ie),a=si(n),c=-r.z,l=c>a?t*a/(c-a)*(1+Math.hypot(r.x,r.y)/c):Math.hypot(innerWidth,innerHeight)*2;return{item:n,p:s.toArray(),r:a,depth:c,v:o,x:(o.x*.5+.5)*innerWidth,y:(-.5*o.y+.5)*innerHeight,radius:l}});for(let n=0;n<Es.length;n++){let s=Es[n],r=e[n],o=ie.position.distanceTo(Fn[n].root.position),a=r.depth<=r.r||r.v.z>1||r.v.z<-1||Math.abs(r.v.x)>1||Math.abs(r.v.y)>1;if(r.item.parent&&o>si(ri.get(r.item.parent))*70&&(a=!0),a||(a=e.some(u=>u!==r&&Ku(i,r.p,u.p,u.r))),a){s.el.hidden=!0;continue}s.el.hidden=!1,s.width||=s.el.offsetWidth,s.height||=s.el.offsetHeight;let c=r.x+r.radius+8,l=r.y,h={left:c+12,right:c+12+s.width,top:l-s.height/2,bottom:l+s.height/2};a=h.right>innerWidth||h.left<0||h.top<0||h.bottom>innerHeight,a||(a=e.some(u=>u!==r&&u.depth>0&&u.depth-u.r<r.depth&&ju(h,u))),s.el.hidden=a,s.el.style.left=c+"px",s.el.style.top=l+"px"}}function D0(){ie.aspect=innerWidth/innerHeight,ie.updateProjectionMatrix(),ge.setSize(innerWidth,innerHeight),As.setPixelRatio(ge.getPixelRatio()),As.setSize(innerWidth,innerHeight);for(let i of Es)i.width=0,i.height=0}addEventListener("resize",D0);var b0=performance.now(),w0=0,y_=0;function L0(i){requestAnimationFrame(L0);let t=(i-b0)/1e3;b0=i;let e=Math.min(t,.08);Z.paused||(Z.ms+=t*1e3*Z.speed),Z.ms>Date.UTC(2101,0,1)&&(Z.ms=Date.UTC(2100,11,31),Z.paused=!0);let n=Z.track?.root.position.clone();if(i-Z.lastEphem>Math.min(1e3,6e4/Z.speed)&&Rr(),n&&Z.track&&!Z.flight&&!Z.transition){let s=Z.track.root.position.clone().sub(n);ie.position.add(s),Fe.target.add(s)}if(Z.transition){let s=Z.transition,r=Math.min(1,(i-s.start)/1400),o=r*r*(3-2*r);ie.position.lerpVectors(s.from,s.to,o),Fe.target.lerpVectors(s.fromTarget,s.target,o),ie.lookAt(Fe.target),r===1&&(Z.transition=null)}else Z.flight?g_(e):(Fe.autoRotate=Z.tour,Fe.update());Ar.position.copy(ie.position),Pr.hidden=!!Z.selected||Z.sector||Z.flight,Math.abs(2e3+(Z.ms-Date.UTC(2e3,0,1))/ws/365.25-Z.starEpoch)>.003&&Kl(),v_(),i-w0>500&&(tt("#clock").textContent=new Date(Z.ms).toISOString().replace("T"," ").slice(0,19),tt("#status").textContent=(Z.sector?"HYG catalogus \xB7 afstanden in pc":Z.physical?"AU-schaal \xB7 echte afstanden en stralen":"Verkenbaar \xB7 vergrote objecten")+" \xB7 "+ge.domElement.width+" \xD7 "+ge.domElement.height,w0=i),As.render(),y_++}async function M_(){try{let i=await fetch("data/stars.json");if(!i.ok)throw Error("Stercatalogus niet beschikbaar");ql=(await i.json()).stars,Kl(),Rr(),$l(),R0(),fetch("data/exoplanets.json").then(e=>e.json()).then(e=>Yl=e).catch(()=>{}),ie.position.set(45,25,70),pn(ri.get(new URLSearchParams(location.search).get("body"))||ri.get("Earth")),tt("#loading").hidden=!0,requestAnimationFrame(L0);let t=document.modelContext;t?.registerTool&&(t.registerTool({name:"navigate_to_cosmic_object",description:"Navigeer in de 3D-kosmos naar een planeet of maan.",inputSchema:{type:"object",properties:{name:{type:"string"}},required:["name"],additionalProperties:!1},annotations:{readOnlyHint:!1},execute({name:e}){if(typeof e!="string"||!e.trim())throw Error("Naam ontbreekt");let n=Fn.find(s=>[s.name,s.id].some(r=>r.toLowerCase()===e.toLowerCase()));if(!n)throw Error("Onbekend object");return pn(n),{shown:n.name,mode:Z.physical?"physical":"explore"}}}),t.registerTool({name:"read_catalog_summary",description:"Lees aantallen en simulatietijd.",inputSchema:{type:"object",properties:{},additionalProperties:!1},annotations:{readOnlyHint:!0},execute(){return{stars:ql.length,planets:_r.length-1,selectedMoons:xr.length,time:new Date(Z.ms).toISOString(),source:"HYG v4.1 / Astronomy Engine"}}}))}catch(i){tt("#progress").textContent="Laden mislukt: "+i.message;let t=document.createElement("a");t.href="atlas.html",t.textContent="Open de lichte atlas",tt("#loading").append(t)}}M_();
